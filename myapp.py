...
class UserInterface(GridLayout):
    ...
    def pythagorean(self):
        ...
        if a == "" and b != "" and c != "":
            ...
            return {"error": "oops! no input was received! please enter 2 side lengths to get the 3rd!"}

        elif (a == "" and b == "" and c != "") or (a == "" and c == "" and b != "") or (
                b == "" and c == "" and a != ""):
            ...
            return {"error": "an unexpected error has occurred. please try again"}
